...
--   2. Hora OPCIONAL en todos los tipos. Sin hora: lanzamiento/fecha_destacada son
--      de «todo el día» (starts_at a 00:00 en su zona); Encuentro asume las 19:00
--      (comportamiento heredado del evento original). No hay guarda de hora obligatoria.
