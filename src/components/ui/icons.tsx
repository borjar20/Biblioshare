...
// ── Set del bosque (mascota RPG, #1165) ────────────────────────────────────
// Seis destinos y acciones del juego. Mismo trazo de 1.8 y `currentColor` que
// el resto: dentro de `/mascota` la marca la ponen el escenario y los sprites,
// no unos iconos de otro estilo.

// Brújula: aventurarse. Sustituye a la diana, que decía «objetivo», no «salir».
...
// Pesa: entrenar. La estrella ya es Logros; dos cosas distintas no comparten glifo.
...
export function PawIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <Icon {...props}>
      <path d="M12 13.5c2.4 0 4.3 1.8 4.3 3.7 0 1.6-1.3 2.6-2.8 2.3l-1.5-.3-1.5.3c-1.5.3-2.8-.7-2.8-2.3 0-1.9 1.9-3.7 4.3-3.7Z" />
      <ellipse cx="7.2" cy="10.4" rx="1.7" ry="2.2" />
      <ellipse cx="16.8" cy="10.4" rx="1.7" ry="2.2" />
      <ellipse cx="10.4" cy="6.6" rx="1.6" ry="2.1" />
      <ellipse cx="13.6" cy="6.6" rx="1.6" ry="2.1" />
    </Icon>
  );
}

// Arco de la madriguera: la puerta del roble, no un grupo de personas.
export function BurrowArchIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <Icon {...props}>
...
// Medalla: los logros conseguidos, dentro del Diario.
export function MedalIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <Icon {...props}>
      <circle cx="12" cy="15" r="6" />
      <path d="m8.5 9.6-3-6.6M15.5 9.6l3-6.6M9.5 3h5" />
    </Icon>
  );
}
