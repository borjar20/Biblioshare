...
import type { MockCommunity } from "@/lib/catalog/mock-community";
import { MEDIA_ACCENT } from "@/lib/catalog/media-accent";
import { RatingDots } from "@/components/ui/rating-dots";
import { HeartIcon } from "@/components/ui/icons";

// "Comunidad" tab body. Rating distribution + reviews are placeholder data
// (see mock-community.ts) — flagged as such so it never reads as real.
    ...
    <div className="flex flex-col gap-10">
      <section className="flex flex-col gap-4">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className="rounded-full border border-border bg-surface-muted px-2 py-0.5 font-mono text-[10px] tracking-wide text-muted-foreground uppercase">
            {t("mockNotice")}
          </span>
        </div>
        ...
        <div className="flex max-w-md items-center gap-6 rounded-xl border border-border bg-surface p-6">
          <div className="flex shrink-0 flex-col items-center gap-1.5">
            ...
            <RatingDots value={community.avgRating} fillClassName={accent.bg} />
