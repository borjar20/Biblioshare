...
// tipo se enchufe sin tocar el núcleo de G. Hoy solo `buddy_read` tiene
// comportamiento real; tierlist/list_challenge/criteria_challenge (bloques
// futuros) llegan como stubs mínimos.
