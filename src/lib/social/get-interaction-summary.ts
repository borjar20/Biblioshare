...
// Lectura en lote de reacciones y comentarios de un conjunto de targets del
// MISMO tipo — cada call site trabaja con uno solo (get-community.ts con
// diary_entry, get-episode-reviews.ts con episode_watch), así que no hace falta
// mezclarlos en una llamada.
//
// Separado de `interactions.ts` en F1-027: allí viven los tipos y las
// constantes, que importan componentes de cliente, y aquí lo que toca BD y
// sesión. Ver la cabecera de aquel fichero para el modo de fallo concreto.
