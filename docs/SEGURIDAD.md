...
| Tokens Supabase en Android | #679 | Código: AES-GCM con Android Keystore, archivo atómico en noBackupFilesDir y exclusión de preferencias antiguas de backup/transferencia. Verificación en dispositivo y distribución pendientes; no implica actualización del APK instalado. |
