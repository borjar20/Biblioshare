...
## 9. `rereadCount` no es el ordinal del pase
...
## 10. Las series no tienen `progress_sessions`
...
## 11. Migraciones: el ledger miente
...
## 12. Las maquetas son documentos vivos
...
## 13. Los docs de plan apuntan a ficheros que se movieron
...
## 14. Preparar datos por la UI no funciona
