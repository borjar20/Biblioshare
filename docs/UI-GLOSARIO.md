...
| **Madriguera** | Ranking de mascotas, Clasificación | El espacio de compañía con las mascotas visibles de tus seguidos y la tuya, si tienes una. Puedes verlo antes de eclosionar. | sección en `/mascota`, S1 #1083 aceptada el 2026-09-07; ampliación de nivel verificada en dev, producción pendiente |
