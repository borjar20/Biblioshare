...
- [x] Crear PR con problema/comportamiento, evidencia, plan de despliegue y rollback. Explicar que no hay caché compartida de datos de usuario. Revisión focalizada de permiso, carrera, compatibilidad y duplicación de recompensas antes de publicar.
