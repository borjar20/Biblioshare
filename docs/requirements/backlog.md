...
- [ ] Mascota RPG R4b: los seis objetos entran en el motor r4.2, dos ranuras, equipar y comparar, iconos y VFX (#1123). Diseño iniciado el 2026-09-08 por petición del usuario; propuesta en `docs/superpowers/specs/2026-09-08-mascota-r4b-botin-design.md`. Pendiente revisión del diseño, implementación y criterios de salida.
