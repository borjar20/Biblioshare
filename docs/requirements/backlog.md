...
- [ ] Mascota RPG R4b: los seis objetos entran en el motor r4.2, dos ranuras, equipar y comparar, iconos y VFX (#1123). Copias con potencia fija y una recompensa por aventura vinculada a actividad, sin resorteos por reintento. Spec `docs/superpowers/specs/2026-09-08-mascota-r4b-botin-design.md`; plan creado a petición del usuario en `docs/superpowers/plans/2026-09-08-mascota-r4b-botin.md`. Pendiente ejecución, calibración y criterios de salida. Utilidad de tinta/desencantado aplazada en #1134.
