...
- [ ] BiblioPlay fases 6+: jugadores habituales / vinculación (`play_players`), estadísticas derivadas del log, sync en tiempo real multi-dispositivo de la partida activa.
