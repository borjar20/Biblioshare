...
- [x] Mascota RPG R2 — legibilidad de la habilidad tras la prueba del usuario (#1082, 2026-09-06): activación manual, efecto y recarga explícitos, avisos de carga/guardia con duración y resultado de la última habilidad fuera del log. Los avisos, el contador y las etiquetas reservan espacio para mantener fijo el botón al cambiar de estado. La aceptación humana continúa pendiente.
- [ ] Mascota RPG R2 — **aceptación humana pendiente en #1082**: comprobar los criterios de la [hoja de ruta, Parte II](../design/2026-09-06-mascota-rpg-evolucion-por-fases.md) después de veinte combates. R2 sigue siendo el hito activo; R3 y su arte esperan esta aceptación. Los hitos R no renumeran las fases 1–3 ya implementadas.
