...
- [x] Mascota RPG R2 — legibilidad de la habilidad tras la prueba del usuario (#1082, 2026-09-06): activación manual, efecto y recarga explícitos, avisos de carga/guardia con duración y resultado de la última habilidad fuera del log. La aceptación humana continúa pendiente.
