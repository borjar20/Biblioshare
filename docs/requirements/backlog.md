...
- [x] Mascota RPG R4a: aventuras derivadas del día con actividad (ventana de siete días), cadena de tres tramos con la vida arrastrada, reintento y reanudación, botín guardado «pendiente de activar», motor r4.1 (cierra #1086, #1087 y #1093). Implementada 2026-09-07 (rama `claude/mascota-features-r4-ef8885`, PR pendiente); calibración: cadena de 3 tramos (política de referencia `interrupt_ulti`, banda 50–75 % / techo `never` 3 %, #1117). Verificada en dev (migración, matriz SQL, unitarios, e2e); mergear a prod tras la aceptación jugable de R3 (#1106). Spec `docs/superpowers/specs/2026-09-06-mascota-r4a-aventuras-design.md`.
