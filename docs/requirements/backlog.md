...
### Sagas
- [ ] **Orden unificado de sagas, fase 2b de 3: ventanas de las entradas `libre`** — `saga_placement_windows` (tabla nueva, no existe todavía) y la curación de "cuándo se puede leer" para los miembros `placement='libre'`. Aplazada a propósito: hoy hay **0 filas `libre`** en prod, así que se estrenaría sin nada que editar. Spec de la fase 1: `docs/superpowers/specs/2026-07-25-sagas-orden-unificado-design.md`.
