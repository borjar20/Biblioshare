...
- [ ] Mascota S2: sprite, nombre, clase y etapa en cabecera de perfil; sprite, nombre y clase en OG anónimo. Implementación y 5 E2E verificados en dev el 2026-09-07; migración y ACL verificadas también en producción. Publicación web mediante PR #1128. Contrato: `docs/superpowers/specs/2026-09-07-mascota-social-s2-design.md`.
