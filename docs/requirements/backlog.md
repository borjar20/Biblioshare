...
- [ ] Mascota RPG R4a: aventuras derivadas del día con actividad (ventana de siete días), cadena de dos o tres tramos con la vida arrastrada, reintento y reanudación, botín guardado «pendiente de activar», motor r4.1 (cierra #1086, #1087 y #1093). Spec `docs/superpowers/specs/2026-09-06-mascota-r4a-aventuras-design.md` (diseñada 2026-09-06; mergear solo tras la aceptación de R3 en #1106).
- [ ] Mascota RPG R4b: los seis objetos entran en el motor, dos ranuras, equipar y comparar, iconos y VFX. Contrato heredado en la Parte II de la hoja de ruta; spec cuando R4a pase sus criterios.
