...
- [ ] Mascota RPG R4–R5: aventuras derivadas de la actividad y primer botín de equipo, dos ranuras (R4); bellotas con la tienda como primer sumidero (R5, parte de #1017).
...
- [ ] Mascota S3: madriguera del club (#1129; tickets #1130–#1132) — implementación técnica y pruebas en desarrollo el 2026-09-07; pendientes aceptación visual de José Ángel y publicación. Spec `docs/superpowers/specs/2026-09-07-mascota-social-s3-design.md`. Miembros activos, privacidad de perfil, bloque compacto en feed, doce iniciales y hasta sesenta vecinas; sin ranking ni tiempo real.
